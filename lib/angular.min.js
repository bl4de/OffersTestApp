/*
 AngularJS v1.3.0-local+sha.219648f
...
(function(N, S, r) {
    ...
    function I(b) {
        return function() {
            var a = arguments[0],
                c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.3.0-local+sha.219648f/" + (b ? b + "/" : "") + a;
    ...
    function aa(b, a) {
        ...
        } else(a = b) && (M(b) ? a = aa(b, []) : qa(b) ? a = new Date(b.getTime()) : eb(b) ? a = RegExp(b.source) : R(b) && (a = aa(b, {})));
        return a
    }
    ...
    function ya(b, a) {
        ...
        if (c == typeof a && "object" == c)
            if (M(b)) {
                ...
                for (d in a)
                    if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== r && !O(a[d])) return !1;
                return !0
            }
        return !1
    }
    ...
    function hd(b, a) {
        ...
        b = y(b);
        for (d = 0; d < e; ++d)
            if (c = hc[d] + a, x(c = b.attr(c))) return c;
        return null
    }
    ...
    function id(b, a) {
        ...
        var d = [b],
            e, f, g = {}, h = ["ng:app", "ng-app", "x-ng-app", "data-ng-app"],
            m = /\sng[:\-]app(:\s*([\w\d_]+);?)?\s/;
        q(h, function(a) {
            h[a] = !0;
    ...
    function ic(b, a, c) {
        ...
        var d = function() {
            ...
            a.unshift("ng");
            d = Eb(a, c.strictDi);
            d.invoke(["$rootScope", "$rootElement", "$compile", "$injector", "$animate",
                function(a, b, c, d, e) {
                    a.$apply(function() {
                        b.data("$injector", d);
                        c(b)(a)
            ...
            if (!d || null != b)
                for (; e.length;)
                    for (k = e.shift(), l = 0, p = k.length; l < p; l++)
                        for (n = y(k[l]), m ? n.triggerHandler("$destroy") : m = !m, t = 0, n = (s = n.children()).length; t < n; t++) e.push(Ga(s[t]));
    ...
    function Nb(b, a, c) {
        ...
        if ("function" == typeof b) {
            if (!(d = b.$inject)) {
                d = [];
                if (b.length) {
                    if (a) throw x(c) && c || (c = b.name || De(b)), Ja("strictdi", c);
    ...
    function Ge(b, a, c, d) {
        ...
        h.cookies = function(a, b) {
            var d, e, f, h;
            if (a) b === r ? m.cookie = escape(a) + "=;path=" + G + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : x(b) && (d = (m.cookie = escape(a) + "=" + escape(b) +
    ...
    function kc(b, a) {
        ...
        this.directive = function m(a, e) {
            Aa(a, "directive");
            x(a) ? (Fb(e, "directiveFactory"), c.hasOwnProperty(a) || (c[a] = [], b.factory(a + d, ["$injector", "$exceptionHandler",
                function(b, d) {
                    var e = [];
                    q(c[a], function(c, f) {
                        try {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache",
            ...
            function(a, b, l, p, n, t, s, J, E, B, z, W) {
                ...
                function K(a, b, c, d, e, f) {
                    ...
                    for (var m = [], k, l, t, p, n = 0; n < a.length; n++) k = new Ob, l = Z(a[n], [], k, 0 === n ? d : r, e), (f = l.length ? ha(l, a[n], k, b, c, null, [], [], f) : null) && f.scope && ma(y(a[n]), "ng-scope"), k = f && f.terminal || !(t = a[n].childNodes) || !t.length ? null : K(t, f ? f.transclude : b), m.push(f, k), p = p || f || k, f = null;
                    return p ? g : null
                }
                ...
                function Z(a, b, c, d, g) {
                    ...
                    switch (a.nodeType) {
                        ...
                        case 8:
                            try {
                                if (k = e.exec(a.nodeValue)) p = na(k[1]), ba(b, p, "M", d, g) &&
                                    (c[p] = Y(k[2]))
                            } catch (z) {}
                    }
                    b.sort(qb);
                ...
                function ha(a, c, d, e, f, g, m, p, n) {
                    ...
                    for (var z = -Number.MAX_VALUE, K, W = n.controllerDirectives,
                        ...
                        if (T = H.scope) K = K || H, H.templateUrl || (A("new/isolated scope", L, H, u), R(T) && (L = H));
                        ca = H.name;
                        !H.templateUrl && H.controller && (T = H.controller, W = W || {}, A("'" + ca + "' controller", W[ca], H, u), W[ca] = H);
                        if (T = H.transclude) qb = !0, H.$$tlb || (A("transclusion", ba, H,
                            u), ba = H), "element" == T ? (w = !0, z = H.priority, T = G(c, Q, V), u = d.$$element = y(S.createComment(" " + ca + ": " + d[ca] + " ")), c = u[0], rb(f, y(ra.call(T, 0)), c), I = v(T, e, z, g && g.name, {
                        ...
                        if (H.template)
                            if (A("template", ha, H, u), ha = H, T = O(H.template) ? H.template(u, d) : H.template, T = U(T), H.replace) {
                                ...
                                T = Jb.test(T) ? y(Y(T)) : [];
                                c = T[0];
                                if (1 != T.length || 1 !== c.nodeType) throw ia("tplrt", ca, "");
                                rb(f, u, c);
                                P = {
                                    $attr: {}
                                };
                        ...
                        if (H.templateUrl) A("template", ha, H, u), ha = H, H.replace && (g = H), J = D(a.splice(ja, a.length - ja), u, d, f, I, m, p, {
                ...
                function D(a, b, c, d, e, f, g, k) {
                    ...
                    b.empty();
                    p.get(B.getTrustedResourceUrl(J), {
                        cache: n
                    }).success(function(p) {
                        var n,
                            B;
                        ...
                        if (s.replace) {
                            p = Jb.test(p) ? y(Y(p)) : [];
                            n = p[0];
                            if (1 != p.length || 1 !== n.nodeType) throw ia("tplrt", s.name, J);
                            p = {
                                $attr: {}
                            };
                            rb(d, b, n);
                            ...
                            compile: function() {
                                return {
                                    pre: function(c, d, m) {
                                        ...
                                        if (f = b(m[e], !0, I(a, e))) m[e] = f(c), (d[e] ||
        ...
        this.$get = ["$injector", "$window",
            function(c, d) {
                return function(e, f) {
                    ...
                    if (m) {
                        if (!f || "object" != typeof f.$scope) throw I("$controller")("noscp", h || e.name, m);
                        f.$scope[m] = g
                    }
                    return g
                }
                ...
                function s(b, c, f) {
                    ...
                    function k() {
                        var a = fb(t.pendingRequests,
                            b); - 1 !== a && t.pendingRequests.splice(a, 1)
                    }
                    var n = p.defer(),
                        s = n.promise,
                        B, q, r = J(b.url, b.params);
    ...
    function Je(b) {
        if (8 >= P && (!b.match(/^(get|post|head|put|delete|options)$/i) || !N.XMLHttpRequest)) return new N.ActiveXObject("Microsoft.XMLHTTP");
    ...
    function ee() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce",
            function(c, d, e) {
                function f(f, k, l) {
                    for (var p,
                            n, t = 0, s = [], J = [], E = [], B = f.length, z = !1, q = !1, v = [], y = {}, K = {}; t < B;)
                        if (-1 != (p = f.indexOf(b, t)) && -1 != (n = f.indexOf(a, p + g))) t !== p && (q = !0), s.push(f.substring(t, p)), t = f.substring(p + g, n), J.push(t), E.push(c(t)), t = n + h, z = !0;
                        else {
    ...
    function Za(b, a) {
        if (b) {
            ...
            if (b.document && b.location && b.alert &&
                b.setInterval) throw Ba("isecwindow", a);
    ...
    function Kc(b, a, c) {
        ...
        if (a.unwrapPromises || 1 !== e)
            if (a.unwrapPromises || 2 !== e)
                if (a.csp) f = 6 > e ? Jc(d[0], d[1], d[2], d[3], d[4], c, a) : function(b, f) {
                    var g = 0,
                        h;
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser",
            function(d, e, f, g) {
                ...
                h.prototype = {
                    constructor: h,
                    $new: function(a) {
                        a ? (a = new h, a.$root = this.$root, a.$$asyncQueue = this.$$asyncQueue, a.$$postDigestQueue = this.$$postDigestQueue) : (a = function() {}, a.prototype = this, a =
                            new a, a.$id = db());
                        a["this"] = a;
                        a.$$listeners = {};
                        a.$$listenerCount = {};
                    ...
                    $digest: function() {
                        ...
                        do {
                            ...
                            a: do {
                                if (h = K.$$watchers)
                                    for (q = h.length; q--;) try {
                                        if (d = h[q])
                                            if ((f = d.get(K)) !== (g = d.last) && !(d.eq ? ya(f, g) : "number" == typeof f && "number" == typeof g && isNaN(f) && isNaN(g))) v = !0, c = d, d.last =
                            ...
                            if ((v || k.length) && !r--) throw n.$$phase = null, a("infdig", b, sa(L));
                        } while (v || k.length);
    ...
    function pe() {
        this.$get = ["$window",
            "$document",
            function(b, a) {
                var c = {}, d = Q((/android (\d+)/.exec(u((b.navigator || {}).userAgent)) || [])[1]),
        ...
        return function(b, a, c) {
            ...
            "function" !== d && (c = "boolean" === d && c ? function(a, b) {
                ...
                if (a && b && "object" === typeof a && "object" === typeof b) {
                    for (var d in a)
                        if ("$" !== d.charAt(0) && Mc.call(a, d) && c(a[d], b[d])) return !0;
                    return !1
                }
                b = ("" + b).toLowerCase();
    ...
    function Xc(b, a, c, d) {
        ...
        f.$setValidity = function(a, b, c) {
            var d = m[a];
            if (b) d && (Ea(d, c), d.length || (h--, h || (e(b), f.$valid = !0, f.$invalid = !1), m[a] = !1, e(!0, a), g.$setValidity(a, !0, f)));
            else {
                h || e(b);
                if (d) {
                    if (-1 != fb(d, c)) return
    ...
    function ab(b, a, c, d, e, f) {
        ...
        var l = function(e) {
            if (!k) {
                var f = a.val(),
                    n = e && e.type;
                if (P && "input" === (e || m).type && a[0].placeholder !== h) h = a[0].placeholder;
                else if (Pa(c.ngTrim || "T") && (f = Y(f)), d.$viewValue !== f || g && "" === f && !g.valueMissing) b.$$phase ? d.$setViewValue(f, n) : b.$apply(function() {
                    d.$setViewValue(f, n)
                })
            }
        };
        ...
        q && ((e = q.match(/^\/(.*)\/([gim]*)$/)) ? (q = RegExp(e[1], e[2]), e = function(a) {
            ...
            var e = b.$eval(q);
            if (!e || !e.test) throw I("ngPattern")("noregexp", q, e, ga(a));
    ...
    var hc = ["ng-", "data-ng-", "ng:", "x-ng-"],
        jd = /[A-Z]/g,
        md = {
            full: "1.3.0-local+sha.219648f",
            major: 1,
            minor: 3,
            dot: 0,
            codeName: "snapshot"
        }, Va =
            U.cache = {}, jb = U.expando = "ng-" + (new Date).getTime(),
        Be = 1,
        sb = N.document.addEventListener ? function(b, a, c) {
    ...
    q({
        ...
        attr: function(b, a, c) {
            ...
            if (nb[d])
                ...
                else return b[a] || (b.attributes.getNamedItem(a) || D).specified ? d : r;
                else
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                var g = this.text.charAt(this.index),
                    e = e + g;
                if (f) "u" === g ? (g = this.text.substring(this.index + 1, this.index + 5), g.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + g + "]"), this.index += 4, d += String.fromCharCode(parseInt(g, 16))) : d = (f = bf[g]) ? d + f : d + g, f = !1;
                else if ("\\" === g) f = !0;
                else {
                    if (g === a) {
                        this.index++;
    ...
    var Yc = function(a) {
        ...
        cd = {
            ...
            number: function(a, c, d, e, f, g) {
                ...
                e.$parsers.push(function(a) {
                    var c = e.$isEmpty(a);
                    if (c || ef.test(a)) return e.$setValidity("number", !0), "" === a ? null : c ? a : parseFloat(a);
        ...
        Ma = "ng-pristine",
        Ab = "ng-dirty",
        gf = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout",
    ...
    var Fd = ["$animate",
        ...
        Gd = ["$http", "$templateCache", "$anchorScroll", "$animate", "$sce",
            function(a, c, d, e, f) {
                return {
                    restrict: "ECA",
                    priority: 400,
                ...
                return {
                    ...
                    link: function(e, f, g, h, m) {
                        ...
                        e.$watchCollection(h, function(a) {
                            ...
                            h = A.length = D.length;
                            for (g = 0; g < h; g++)
                                if (u = a === D ? g : D[g], x = a[u], x = p(u, x, g), Aa(x, "`track by` id"), z.hasOwnProperty(x)) w = z[x], delete z[x], B[x] = w, A[g] = w;
                                else {
                                    if (B.hasOwnProperty(x)) throw q(A, function(a) {
                                        a && a.scope && (z[a.id] = a)
                                    }), d("dupes", k, x);
                                    A[g] = {
                                        id: x
                ...
                return {
                    ...
                    link: function(e, g, h, m) {
                        ...
                        function p(e, f, g) {
                            ...
                            var k;
                            if (!(k = s.match(d))) throw jf("iexp", s, ga(f));
                            var l = c(k[2] || k[1]),
                                m = k[4] || k[6],
                                n = k[5],
                                p = c(k[3] || ""),
